						...
						try{
							...
							for (var datafield in obj) 
							{
								...
								if(approve_district=="yes"){
									var approve_district_part = "<td><button class='btn btn-info'>Implemented</button></td>";
								}
								else if(approve_district=="no"){
									var approve_district_part = "<td><button class='btn btn-danger'>Non Implemented</button></td>";
								}
								...
								if(approve_admin=="yes"){
									var approve_admin_part = "<td><button class='btn btn-info'>Approve</button></td>";
								}
