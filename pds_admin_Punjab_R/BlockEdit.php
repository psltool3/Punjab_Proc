...
$uid = $_POST['uid'];
$query = "SELECT * FROM block WHERE id='$uid'";
...
<script>
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="Block.php">Home</a></li>
                    <li class="active">Block Edit</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/BlockEdit.php" method="POST" class="form-horizontal">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to Edit Block Name.</p>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <span class="help-block">Block Name</span>
                                                </div>
                                            </div>
