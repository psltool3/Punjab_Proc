...
<script src="js/Encryption.js"></script>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                    <h3 class="panel-title">Blocks Data</h3>
                                </div>
								<a href="BlockAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a> 
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"BlockEdit.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/BlockDelete.php");
		}
