...
if(isset($_POST["uid"])){
	...
	if($numrows!=0){
		...
		$Paddy_Procurement = $row['Paddy_Procurement'];
...
<script>
                             ...
                             <div class="panel-body">
                                    ...
                                    <div class="row">
										...
										<div class="form-group">
                                                <label class="col-md-3 control-label">PC District*</label>
                                                <div class="col-md-9">
										...
										<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="PC_ID" name="PC_ID" value="<?php echo $PC_ID ?>" style="color: black; font-weight: bold;" readonly required />
                                                    </div>
                                                    <span class="help-block">PC ID (readonly)</span>
                                                </div>
                                            </div>
										...
										<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="milling_center" name="milling_center" value="<?php echo $milling_center ?>" required />
                                                    </div>
										...
										<div class="form-group">
                                                <label class="col-md-3 control-label">PC Latitude*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
										...
										<div class="form-group">
                                                <label class="col-md-3 control-label">PC Longitude*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
										...
										<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <span class="help-block">Paddy Procurement (numeric)</span>
                                                </div>
                                            </div>
    ...
    <!-- START SCRIPTS -->
		...
		function showPopup() {
			...
			var Paddy_Procurement = document.getElementById('Paddy_Procurement').value;
			var milling_center = document.getElementById('milling_center').value;

            if (district === '' || name === '' || PC_ID === '' || latitude === '' || longitude === '' || Paddy_Procurement === '' || milling_center === '') {
