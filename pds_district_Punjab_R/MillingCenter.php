...
<style>
    ...
    .table thead tr th {
        ...
        color: black;
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Milling Centers</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
                                <h3 class="panel-title">Milling Centers Data</h3>
                            </div>
							<a href="MillingCenterAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a>
                                ...
                                <table id="export_table" class="table">
									...
									while ($row = mysqli_fetch_array($result)) {
										...
										echo "<tr>
											...
											<td><button class='btn btn-danger btn-rounded' onclick=\"delete_entry('{$temp_id}')\">Delete</button></td>
										</tr>";
									}
									if ($numrows == 0) {
										echo "<tr><td colspan='3' class='text-center'>No milling centers found.</td></tr>";
									}
									?>
                                    </tbody>
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id) {
			post({uid: temp_id}, "MillingCenterEdit.php");
		}
		...
		function VerifyAndDelete() {
			...
			post({uid: temp_id, username: username, password: encrypted}, "api/MillingCenterDelete.php");
		}
