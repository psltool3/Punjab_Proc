...
if ($uid) {
	$query = "SELECT * FROM milling_center WHERE id='$uid'";
	...
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Edit Milling Center</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/MillingCenterEdit.php" method="POST" class="form-horizontal">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to edit Milling Center Name.</p>
                                </div>
