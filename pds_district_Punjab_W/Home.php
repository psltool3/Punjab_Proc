...
if (!empty($id)) {
	...
	$query = "SELECT approve_admin FROM `". $tablename ."` WHERE to_district='$districtSafe' AND approve_admin='yes'";
	$result = mysqli_query($con,$query);
	if ($result) {
	...
	function setSelectedValue1(obj_value,valueToSet) {
		...
		for (var i = 0; i < obj.options.length; i++) {
			if (obj.options[i].text== valueToSet) {
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Punjab Procurement Route Optimisation</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
								<div class="panel-heading">
                                    <h3 class="panel-title">Punjab Procurement Route Optimisation - <b><?php echo $district; ?></b> <div id="timer"> <b>Time Left &nbsp </b> <span id="countdown"></span></h3>
                                </div>
                            </div>
							<div class="row">
