                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
								...
								<a href="BulkWarehouseStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">District Wise Status Change</button></a>
                                 ...
                                 <div class="table-responsive">
                                    <table id="export_table" class="table datatable">
                                        <thead>
											...
											<th style="font-size:15px">Capacity Available</th>
