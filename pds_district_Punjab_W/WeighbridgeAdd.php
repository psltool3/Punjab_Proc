	...
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Weighbridge Add</li>
                </ul>
                <!-- END BREADCRUMB -->
                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/WeighbridgeAdd.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                            <div class="panel panel-default">
                               <div class="panel-body">
                                    <p>Fill this form to add new weighbridge.</p>
                                </div>
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="Storage_Point" name="Storage_Point" required />
                                                    </div>
