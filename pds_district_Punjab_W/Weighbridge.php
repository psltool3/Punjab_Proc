...
<style>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
								...
								<a href="BulkWeighbridgeStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">District-Wise Status Change</button></a>
								<a href="BulkWeighbridgeDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Bulk Data Edit</button></a>
								<a href="BulkWeighbridgeData.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Bulk Data Add</button></a>
								...
								<a href="WeighbridgeAdd.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-success">Add New</button></a>
                                <a href="api/BulkWeighbridgeDownloadEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Download Data</button></a>
                                ...
                                <div class="panel-body">
                                 <div class="table-responsive">
                                    <table id="export_table" class="table datatable">
										...
										$query = "SELECT * FROM weighbridge WHERE District='$district' ORDER BY District";
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"WeighbridgeEdit.php");
		}
		
		function change_status(temp_id){
			post({uid: temp_id} ,"api/WeighbridgeStatus.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/WeighbridgeDelete.php");
		}
