	...
	function setSelectedValue1(obj_value,valueToSet) {
		...
		for (var i = 0; i < obj.options.length; i++) {
			if (obj.options[i].text== valueToSet) {
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Punjab Optimised Planning (Mill to Warehouse)</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
								<div class="panel-heading">
                                    <h3 class="panel-title">Punjab Optimised Planning (Mill to Warehouse) - <b><?php echo $district; ?></b> <div id="timer"> <b>Time Left &nbsp </b> <span id="countdown"></span></h3>
                                </div>
                            </div>
							<div class="row">
