...
if(isset($_POST["uid"])){
	$uniqueid = $_POST["uid"];
	$query = "SELECT * FROM pc2 WHERE uniqueid='$uniqueid'";
...
<script>
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <span class="help-block">Paddy Procurement (in Qtl)</span>
                                                </div>
                                            </div>
											...
											<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="Storage_Point" name="Storage_Point" value="<?php echo $Storage_Point ?>" />
                                                    </div>
    ...
    <!-- START SCRIPTS -->
		...
		function showPopup() {
            ...
            if (name === '' || latitude === '' || longitude === '' || id === '' || Paddy_Procurement === '' || district === '') {
