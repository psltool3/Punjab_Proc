	...
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Weighbridge Bulk Add</li>
                </ul>
                <!-- END BREADCRUMB -->
				...
				<!-- PAGE CONTENT WRAPPER -->
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<a href="api/BulkWeighbridgeDownload.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Download Template</button></a>
                            <form action="api/BulkWeighbridgeData.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
