    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				...
				<li>
					<a href="Weighbridge.php" style="padding-left:0px"><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Edit Weighbridge</span></a>
				</li>
				<li>
